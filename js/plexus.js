(function() {
  ...
  var COLORS = [
    'rgba(0,113,227,',  // primary blue
    'rgba(41,151,255,',  // primary-on-dark lighter blue
    'rgba(0,119,237,'    // primary-hover
  ];
  ...
  function init() {
    resize();
    count = Math.min(Math.floor(w * h / 12000), 70);
  ...
  function draw() {
    ...
    for (var i = 0; i < count; i++) {
      ...
      if (dist < 140) {
        ...
        ctx.strokeStyle = p.color + (0.3 * (1 - dist / 140)) + ')';
        ctx.lineWidth = 0.6;
        ctx.stroke();
      }
