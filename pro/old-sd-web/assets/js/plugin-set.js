jQuery(document).ready(function () {
  ...
  if (lGgall.length) {
    $(".w-gallery-container").lightGallery({ thumbnail: true });
  } else {
    // nothing happen
  }
  ...
  if (popgaller.length) {
    $(".popgaller").lightGallery({ thumbnail: true });
  } else {
    // nothing happen
  }
  ...
  // owlCarousel team
  var slider = $("#owl-team").owlCarousel({
    responsiveClass: true,
    responsive: {
      0: {
        items: 1,
  ...
  // team 3 carousel code
  $("#owl-team3").owlCarousel({
    responsiveClass: true,
    responsive: {
      0: {
        items: 1,
  ...
  // team 4 carousel code
  $("#owl-team4").owlCarousel({
    responsiveClass: true,
    responsive: {
      0: {
        items: 1,
  ...
  // Draftsman and ass architect carousel code
  $("#draftsman").owlCarousel({
    responsiveClass: true,
    responsive: {
      0: {
        items: 1,
  ...
  if ($Wcontainerpro.length) {
    $Wcontainerpro.isotope({ itemSelector: ".w-gallery", filter: "*" });
  ...
  // revolution slider
  var revapi;
  revapi = jQuery("#revolution-slider-full").revolution({
    delay: 9000,
    startwidth: 960,
    startheight: 630,
    onHoverStop: "on",
